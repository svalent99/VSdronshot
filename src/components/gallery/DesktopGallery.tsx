...
const DesktopGallery = ({ 
  ...
  return (
    <div className="w-full h-full p-4 md:p-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 max-w-7xl mx-auto gap-4 relative">
      {cards.map((card, i) => (
        <div key={i} className={cn(card.className, "")}>
          <motion.div
            ...
            className={cn(
              card.className,
              "relative overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-shadow",
              selected?.id === card.id
